            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-6">
                  23 år gammel • Ski • IT og informasjonssystemer
                </p>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Student med variert kompetanse og kreativitet som styrke. Interessert i design, 
                  programmering og kunstig intelligens. Trives med å finne løsninger som kombinerer 
                  praktiske behov og nye ideer.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-6">
                <p>
                  Jeg heter Jonas, er 23 år gammel og kommer fra Ski. Tidligere arbeidserfaringer har 
                  bidratt til å gi meg gode samarbeidsevner, struktur i arbeidsprosesser og viktige 
                  sosiale ferdigheter. I tillegg har jeg bygget min egen PC, noe som har gitt meg 
                  innsikt i både maskinvare og systemforståelse.
                </p>
                
                <p>
                  I gruppe arbeid bidrar jeg med variert kompetanse hvor kreativitet er en av mine 
                  styrker og jeg trives med å finne løsninger som kombinerer praktiske behov og nye ideer.
                </p>
                
                <p>
                  Innen IT interesserer jeg meg spesielt for design, programmering og kunstig intelligens. 
                  Jeg liker å jobbe med prosjekter der tekniske løsninger og brukervennlighet henger sammen, 
                  og er motivert av å samarbeide med andre for å nå gode resultater.
                </p>

                <p>
                  På fritiden driver jeg med pc og er aktiv innen sport, særlig kampsport, fotball og 
                  styrketrening. Jeg setter pris på sosiale aktiviteter og liker å holde en god balanse 
                  mellom studier, trening og fritid.
                </p>
              </div>
            </div>
          </div>
